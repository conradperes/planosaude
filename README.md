# planosaude serverless API
The planosaude project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=planosaude -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.3 -DgroupId=sparta.planosaude.service -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd planosaude
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "PlanosaudeApi",
                    "OutputKey": "PlanosaudeApi",
